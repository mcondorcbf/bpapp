        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config("Reportes Centrales Telefónicas", "Reportes Centrales Telefónicas") }}
                </a>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @else
                        ...
                        @endif
                        <li>
                            <a href="{{url('centrales')}}" class="nav nav-tabs"><span class="glyphicon glyphicon-dashboard"></span> Principal</a>
                        </li>
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle nav nav-tabs" data-toggle="dropdown" role="button" aria-expanded="false">
