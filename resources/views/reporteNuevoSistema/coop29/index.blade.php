    ...
    <div class="panel with-nav-tabs panel-success">
        <div class="panel-heading">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#primer_reporte" data-toggle="tab" onclick="$('#reporte_nro').val(1);">REPORTE ACUMULADO DE GESTIONES</a></li>
                <li class="nav-item"><a href="#segundo_reporte" data-toggle="tab" onclick="$('#reporte_nro').val(2);">REPORTE SEGUIMIENTO DE FACTURACION</a></li>
                    ...
                    <div class="tab-content tab-content-border" >
                        <div class="tab-pane fade active in" id="primer_reporte">
                            <div class="col-md-12 col-lg-12">
                                <form role="search" action="rAcumuladoGestiones29" method="post">
                                            {{ csrf_field() }}
                                            <div class="well">
                                                <table class="table">
                                                    <thead>
                        ...
                        <div class="tab-pane fade" id="segundo_reporte">
                            <div class="col-md-12 col-lg-12">
                                <form role="search" action="rSeguimientoFacturacion29" method="post">
                                    {{ csrf_field() }}
                                    <div class="well">
                                        <table class="table">
                                            <thead>
