        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    ...
                    @endif
                    <br>
                    {!! Form::open(array('url'=>'/agendarCitasPropiasN/','method'=>'POST'))!!}
                    {{ csrf_field() }}
                    <div class="panel-body">
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            <label class="col-lg-4">Fecha y hora de la cita: *</label>
                            <div class='col-lg-4 input-group date' id='datetimepicker1'>
                                <input type="text" class="span2 form-control" value="{{date('Y-m-d H:i')}}" id="fecha_cita" name="fecha_cita" required>
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            ...
                            <div class="col-lg-12">
                                <input name="telefono" type="text" class="form-control" value="" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            ...
                            <div class="col-lg-12">
                                <input name="direccion_cita" type="text" class="form-control" value="" required>
                            </div>
                        </div>

                        <div class="col-lg-12 col-md-12" >
                            <label class="col-lg-12">Observaciones: </label>
                            <textarea name="observacion" type="text" class="form-control" value="" required></textarea>
                        </div>
