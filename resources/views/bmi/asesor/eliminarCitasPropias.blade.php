        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    ...
                    @endif
                    <br>
                    {!! Form::open(array('url'=>'/eliminarCitaPropia','method'=>'POST'))!!}
                    {{ csrf_field() }}
                    <div class="panel-body">
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            <label class="col-lg-4">Fecha y hora de la cita: *</label>
                            <div class='col-lg-4 input-group date' id='datetimepicker1'>
                                <input type="text" class="span2 form-control" value="{{$cliente_propio->fecha_cita}} {{$cliente_propio->hora_cita}}" id="fecha_cita" name="fecha_cita" required disabled>
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input name="nombres" type="text" class="form-control" value="{{$cliente_propio->nombres}}" required disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            ...
                            <div class="col-lg-12">
                                <input name="telefono" type="text" class="form-control" value="{{$cliente_propio->telefono}}" required disabled>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            ...
                            <div class="col-lg-12">
                                <input name="direccion_cita" type="text" class="form-control" value="{{$cliente_propio->direccion_cita}}" required disabled>
                            </div>
                        </div>

                        <div class="col-lg-12 col-md-12" >
                            <label class="col-lg-12">Observaciones: </label>
                            <textarea name="observacion" type="text" class="form-control" required disabled>{{$cliente_propio->observacion}}</textarea>
                        </div>
                        <div class="col-lg-12 col-md-12" >
                            <label class="col-lg-12">Motivo de anulación: </label>
                            <textarea name="observacion_anulacion" type="text" class="form-control" required></textarea>
                            <input name="id_ap" type="hidden" value="0">
                            <input name="id_asesor" type="hidden" value="{{$cliente_propio->asesor}}">
                            <input name="id_cita" type="hidden" value="{{$cliente_propio->id_cita}}">
                        </div>
