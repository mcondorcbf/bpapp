            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}">
                        {{ config("Sistema IVR's", "Sistema IVR's") }}
                    </a>
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            ...
                            @endif
                            <li>
                                <a href="{{url('ivr')}}" class="nav nav-tabs"><span class="glyphicon glyphicon-dashboard"></span> Panel IVR's</a>
                            </li>
                            <li>
                                <a href="{{url('nuevoIvr')}}" class="nav nav-tabs"><span class="glyphicon glyphicon-new-window"></span> Nuevo IVR</a>
                            </li>
                            <li>
                                <a href="{{url('reportesIvr')}}" class="nav nav-tabs"><span class="glyphicon glyphicon-list-alt"></span> Reportes</a>
                            </li>
                                @if(Role::where('id',Auth::user()->role_id)->first()->name=='ivradministrador')
                            <li>
                                <a href="{{url('canalesIvr')}}" class="nav nav-tabs"><span class="glyphicon glyphicon-th-large"></span> Canales</a>
                            </li>
                                @endif
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle nav nav-tabs" data-toggle="dropdown" role="button" aria-expanded="false">
