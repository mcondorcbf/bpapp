                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            ...
                            @if($cita->id_cita_orig==null)
                                <input type="hidden" value="{{$cita->id_cita}}" id="id_cita_orig" name="id_cita_orig" required>
                            @else
                                <input type="hidden" value="{{$cita->id_cita_orig}}" id="id_cita_orig" name="id_cita_orig" required>
                            @endif
