        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('Reportes Cobefec', 'Reportes Cobefec') }}
                </a>
                    ...
                    @else
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle nav nav-tabs" data-toggle="dropdown" role="button" aria-expanded="false">
                                Parámetros<span class="caret"></span>
                            </a>
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="{{url('/rParametrosCex')}}" class="nav nav-tabs"><span class="glyphicon glyphicon-filter"></span> Parametros</a>
                                </li>
                            </ul>
                        </li>
