...
<ul class="nav nav-pills" id="myTab" role="tablist">
    <li class="nav-item">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#paradas" role="tab" aria-controls="paradas" aria-selected="true">PARADAS</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#aplicaciones" role="tab" aria-controls="aplicaciones" aria-selected="false">APLICACIONES INSTALADAS</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#otros" role="tab" aria-controls="contact" aria-selected="false">OTROS DATOS</a>
    </li>
</ul>
<div class="tab-content" id="myTabContent">
    ...
    <div class="tab-pane fade" id="otros" role="tabpanel" aria-labelledby="otros-tab">
        <table id="tbl_ca" class="table table-bordered" style="width:100%; font-size: 11px;">
            ...
            <tbody>
            <?php $i=1; $appStatus=''; $zona_horaria=''; $status_gps='';?>
            @foreach($datos as $dato)
                ...
                @endif
                @if($dato['appStatus']=='' && $dato['zona_horaria']=='' && $dato['status_gps']=='')
                @else
                <tr>
                    <td>{{$i}}</td>
                    <td>{{$dato['imei']}}</td>
