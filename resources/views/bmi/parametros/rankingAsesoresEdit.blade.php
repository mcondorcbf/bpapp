    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel-heading"><h3>Ranking de asesores nivel: {{$asesor->nivel}}</h3></div>
                <div class="panel panel-default">
                    <br>

                    {!! Form::open(array('url'=>'rankingAsesorP','method'=>'POST'))!!}
                    {{ csrf_field() }}
                    <div class="panel-body">
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            <label class="col-lg-3">Valor Inicial *</label>
                            <div class='col-lg-3 input-group'>
                                <input type="hidden" value="{{$asesor->id_ranking}}" id="id_ranking" name="id_ranking">
                                <input type="number" class="form-control" value="{{$asesor->valor_inicial}}" id="valor_inicial" name="valor_inicial" required>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            <label class="col-lg-3">Valor Final: *</label>
                            <div class='col-lg-3 input-group'>
                                <input type="number" class="form-control" value="{{$asesor->valor_final}}" id="valor_final" name="valor_final" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            ...
                            <div class='col-lg-3 input-group'>
                                <input type="number" class="form-control" value="{{$asesor->nivel}}" id="nivel" name="nivel" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-12" >
                            ...
                            <div class='col-lg-6 input-group'>
                                <input type="text" class="form-control" value="{{$asesor->descripcion}}" id="descripcion" name="descripcion" required>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-md-6" style="margin-bottom: 10px">
                            <br>
                            <div class="col-lg-12 col-md-12">
                                <a href="{{url('rankingAsesores')}}" id="atras"  class="btn btn-primary"><span class="glyphicon glyphicon-backward"></span> Atras </a>
