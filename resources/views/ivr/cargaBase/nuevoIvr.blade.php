        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="panel panel-default">
                ...
                <div class="col-lg-11 col-md-11" style="margin-bottom: 10px">
                    ...
                    <strong style="color:#c73535">Nota: </strong>Recuerde que su archivo excel debe contener siempre la columna telefono.
                    </span>
                </div>
                ...
                <div class="col-lg-2 col-md-2">
                    <a id="validar"  class="btn btn-success btn-sm" onclick="validacion()">Validar <span class="glyphicon glyphicon-ok"></span></a>
                </div>
                </div>
                <br>
                <div class="col-lg-12 col-md-12">
                    <a href="{{url('ivr')}}" id="atras" class="btn btn-primary"><span class="glyphicon glyphicon-backward"></span> Atras</a>
                    <button type="submit" id="siguiente" class="btn btn-primary" disabled>Siguiente <span class="glyphicon glyphicon-forward"></span></button>
                </div>
                {!! Form::close() !!}
                <br><br>&nbsp;
                <br>&nbsp;
