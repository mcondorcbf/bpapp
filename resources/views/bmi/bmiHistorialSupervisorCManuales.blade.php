        ...
        <div class="panel with-nav-tabs panel-danger">
            <div class="panel-heading">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="{{url('/historialCitasM')}}">HISTORIAL CITAS MANUALES AGENCIA</a></li>
            ...
            <div class="panel-body">
                <div class="content">
                    <div class="panel with-nav-tabs panel-danger">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#primer_reporte" data-toggle="tab" onclick="$('#reporte_nro').val(1);">SEGUIMIENTO <span class="badge">{{count($citas_manuales_seguimiento)}}</span></a></li>
                                <li class="nav-item"><a href="#segundo_reporte" data-toggle="tab" onclick="$('#reporte_nro').val(2);">FINALIZADAS <span class="badge">{{count($citas_manuales_finalizadas)}}</span></a></li>
                                <input type="hidden" id="reporte_nro" value="1">
                            </ul>
                        </div>
                        <div class="panel-body">
