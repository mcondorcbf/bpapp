        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="panel panel-default">
                    ...
                    {!! Form::open(array('url'=>'asesorbmi','method'=>'POST'))!!}
                    {{ csrf_field() }}
                    <div class="panel-body">
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            <label class="col-lg-12">Correo corporativo:</label>
                            <div class="col-lg-12">
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            <label class="col-lg-12">Código: *</label>
                            <div class="col-lg-12">
                        ...
                        <div class="col-lg-12 col-md-12" >
                            <label class="col-lg-12">Fecha de contrato: * </label>
                        ...
                        <div class="col-lg-12 col-md-12" style="margin-bottom: 10px">
                            <label class="col-lg-12">Enmienda Contrato:</label>
                            <div class="col-lg-12">
                                <input name="enmienda_contrato" type="text" class="form-control" value="">
                            </div>
                        </div>
